...
// _WORD_SIZE should be the fastest or "natural" data size
// _MAX_SIZE  should be the size of the largest data type
//#define _WORD_SIZE sizeof(int)
#define _WORD_SIZE 4
#define _MAX_SIZE  8
...
#ifndef MACHINE
#error "In <sys/cfg.h> please define MACHINE"
#endif

#ifndef CHIP
#error "In <sys/cfg.h> please define MACHINE to have a legal value"
#endif
